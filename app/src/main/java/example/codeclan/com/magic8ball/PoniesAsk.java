 ...
 */
public class PoniesAsk extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        setContentView(R.layout.ponies);
        ...
        mFortuneButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent submitQuestion = new Intent(PoniesAsk.this, PoniesAnswer.class);
        ...
        mChoicesButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent submitQuestion = new Intent(PoniesAsk.this, ChoicesList.class);
