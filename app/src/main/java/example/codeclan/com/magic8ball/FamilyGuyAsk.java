 ...
 */
public class FamilyGuyAsk extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        setContentView(R.layout.familyguy);
        ...
        mFortuneButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent submitQuestion = new Intent(FamilyGuyAsk.this, FamilyGuyAnswer.class);
        ...
        mChoicesButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent submitQuestion = new Intent(FamilyGuyAsk.this, ChoicesList.class);
